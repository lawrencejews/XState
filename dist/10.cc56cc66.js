...
var displayService = (0, _xstate.interpret)(displayMachine).onTransition(function (state) {
  elApp.dataset.state = state.toStrings().join(" ");
}).start(); // Add event listeners for:
...
elOffButton.addEventListener("click", function () {
  displayService.send("TURN_OFF");
});
elModeButton.addEventListener("click", function () {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","10/index.js"], null)
//# sourceMappingURL=/10.cc56cc66.js.map