      ...
      case _actionTypes.choose:
        {
          ...
          var resolved = resolveActions(machine, currentState, updatedContext, _event, toActionObjects((0, _utils.toArray)(matchedActions)));
...
var assignPoint = (0, _xstate.assign)({
  px: function px(context, event) {
    return event.clientX;
  },
  py: function py(context, event) {
    return event.clientY;
  }
});
var assignPosition = (0, _xstate.assign)({
  x: function x(context, event) {
    return context.x + context.dx;
  },
  y: function y(context, event) {
...
var assignDelta = (0, _xstate.assign)({
  dx: function dx(context, event) {
    return event.clientX - context.px;
  },
  dy: function dy(context, event) {
    return event.clientY - context.py;
  }
});
var assignXDelta = (0, _xstate.assign)({
  dx: function dx(context, event) {
    return event.clientX - context.px;
  }
});
var resetPosition = (0, _xstate.assign)({
  dx: 0,
  dy: 0,
  px: 0,
  py: 0
});
var displayMachine = (0, _xstate.createMachine)({
  initial: "hidden",
  states: {
    hidden: {},
    visible: {
...
var dragDropMachine = (0, _xstate.createMachine)({
  initial: "idle",
  context: {
    x: 0,
    y: 0,
...
var service = (0, _xstate.interpret)(dragDropMachine);
...
service.start();
elBox.addEventListener("mousedown", function (event) {
  service.send(event);
});
elBody.addEventListener("mousemove", function (event) {
  service.send(event);
});
elBody.addEventListener("mouseup", function (event) {
  service.send(event);
});
...
},{"xstate":"../node_modules/xstate/es/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","09/index.js"], null)
//# sourceMappingURL=/09.d2fd139f.js.map